...
public final class ekh {
    ...
    private static final char f26045a = '=';

    /* renamed from: a, reason: collision with other field name */
    private static final int f8949a = 128;

    /* renamed from: a, reason: collision with other field name */
    private static final boolean f8950a = false;

    /* renamed from: a, reason: collision with other field name */
    private static final byte[] f8951a = new byte[128];

    /* renamed from: a, reason: collision with other field name */
    private static final char[] f8952a = new char[64];

    /* renamed from: b, reason: collision with root package name */
    private static final int f26046b = 64;
    ...
    static {
        ...
        while (true) {
            ...
            f8951a[i7] = (byte) ((i7 - 48) + 52);
            i7--;
        }
        byte[] bArr = f8951a;
        bArr[43] = 62;
        bArr[47] = 63; // hpx.f28688a
        for (int i8 = 0; i8 <= 25; i8++) {
            f8952a[i8] = (char) (i8 + 65);
        }
        int i9 = 0;
        while (i <= 51) {
            f8952a[i] = (char) (i9 + 97);
    ...
    public static String a(byte[] bArr) {
        ...
        while (i3 < i2) {
            ...
            byte b5 = (byte) (b3 & 15);
            byte b6 = (byte) (b2 & 3);
            int i9 = b2 & Byte.MIN_VALUE; // Byte.MIN_VALUE;
            int i10 = b2 >> 2;
            if (i9 != 0) {
                i10 ^= 192;
            }
            byte b7 = (byte) i10;
            int i11 = b3 & Byte.MIN_VALUE; // Byte.MIN_VALUE;
            int i12 = b3 >> 4;
            if (i11 != 0) {
                i12 ^= 240; // OpenApiConstant.DialogBitmapArgsConstant.DIALOG_WIDTH_3
            }
            byte b8 = (byte) i12;
            int i13 = (b4 & Byte.MIN_VALUE) == 0 ? b4 >> 6 : (b4 >> 6) ^ 252; // Input.Keys.F9
            int i14 = i5 + 1;
            char[] cArr2 = f8952a;
            cArr[i5] = cArr2[b7];
            int i15 = i14 + 1;
            ...
            cArr[i16] = cArr2[b4 & 63]; // hpx.f28688a
            i3++;
            i5 = i16 + 1;
            i4 = i8;
        }
